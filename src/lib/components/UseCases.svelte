		...
		<div class="st-headline">
			...
			<span class="st-line"
				><span class="st-line-inner"
					>{$t('usecases.line2')} <span class="st-gradient">{$t('usecases.line2_accent')}</span></span
				></span
			>
...
<style>
	...
	.glow-center {
		...
		width: 800px;
		height: 500px;
		background: radial-gradient(ellipse, rgba(124, 92, 191, 0.07) 0%, rgba(79, 142, 247, 0.04) 40%, transparent 70%);
		pointer-events: none;
