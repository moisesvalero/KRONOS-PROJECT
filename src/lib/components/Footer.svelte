	...
	<div class="footer-inner">
		...
		<div class="footer-right">
			...
			<span class="footer-credit"
				>{$t('footer.designedBy')}
				<a href="https://moisesvalero.es" target="_blank" rel="noopener noreferrer">Moisés Valero</a></span
			>
		</div>
	</div>
</footer>
...
<style>
	.footer {
		...
		background-image:
			linear-gradient(to right, rgba(148, 163, 184, 0.25), rgba(99, 102, 241, 0.6), rgba(148, 163, 184, 0.25)),
